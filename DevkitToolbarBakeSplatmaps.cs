...
{
    public class DevkitToolbarBakeSplatmaps : Sleek2ImageButton
    {
        ...
        protected override void handleButtonClick()
        {
            if (Level.isEditor)
            {
                UnturnedLog.info("Baking splatmap for level.");
                LevelGround.bakeMaterials(true);
            }
            base.handleButtonClick();
        }
        public DevkitToolbarBakeSplatmaps()
        {
            ...
            this.label.translation = new TranslatedText(new TranslationReference("SDG", "Devkit.Toolbar.File.Bake_Splatmaps"));
