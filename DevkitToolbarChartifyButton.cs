...
{
    public class DevkitToolbarChartifyButton : Sleek2ImageButton
    {
        ...
        protected override void handleButtonClick()
        {
            if (Level.isEditor)
            {
                UnturnedLog.info("Generating chart for level.");
                Level.chartify();
            }
            base.handleButtonClick();
        }
        public DevkitToolbarChartifyButton()
        {
            ...
            this.label.translation = new TranslatedText(new TranslationReference("SDG", "Devkit.Toolbar.File.Chartify"));
